        ...
        <div className="space-y-5 mt-6">
          {data.experience.map((exp, idx) => (
            <div key={idx} className="card overflow-hidden">
              {/* Header */}
              <div className="bg-[#13131c] border-b border-white/[0.06] p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="p-5">
                {/* Project-based experience (Gowebez) */}
                {exp.projects ? (
                  <div className="space-y-5">
                    {exp.projects.map((proj, pIdx) => (
                      <div key={pIdx} className={`${pIdx !== 0 ? "pt-5 border-t border-white/[0.06]" : ""}`}>
                        {/* Project name */}
                        ...
                        {/* Points */}
                        <ul className="space-y-2 mb-3 pl-3.5">
                  ...
                  /* Responsibility-based experience (Yoho) */
                  <>
